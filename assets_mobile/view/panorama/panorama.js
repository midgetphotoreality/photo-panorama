    ...
    var _panorama = function (canvas, container, width, height, webgl) {
        var camera, scene, renderer, mesh,
            ...
            _init = function (imageUrl) {
                ...
                container.addEventListener('touchstart', _onPanoMouseDown, false);
                container.addEventListener('touchmove', _onPanoMouseMove, false);
                container.addEventListener('touchend', _onPanoMouseUp, false);
                container.addEventListener('touchcancel', _onPanoMouseUp, false);
            ...
            _public = {
                ...
                infoScreen: function (elem) {
                    _infoScreen = elem
                },
                overdraw: function () {
                    if (arguments.length > 0) {
                        _overdraw = arguments[0]
                    } else {
                        return _overdraw
                    }
                }
...
*/
    ...
    var _show = function () {
        ...
        Core.dom.removeClass(document.getElementById('levelOverlay'), "hidden");
    ...
    var _remove = function () {
        ...
        Core.dom.addClass(document.getElementById('levelOverlay'), "hidden");
